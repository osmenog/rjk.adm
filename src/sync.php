...
function curl_send($address, $post_data) {
  ...
  */
  CURLOPT_HEADER => false, CURLOPT_POST => true, CURLOPT_POSTFIELDS => $post_data, CURLOPT_RETURNTRANSFER => true,
  ...
  $header = curl_getinfo($curl_link);
   //Получаем расширенную инфу о выполненном запросе
